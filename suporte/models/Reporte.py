...
class Reporte(models.Model):
    ...
    equipamento = models.ForeignKey(Equipamento, on_delete=models.RESTRICT, null=False, related_name='reportes')
    usuario = models.ForeignKey(Usuario, on_delete=models.RESTRICT, null=False, related_name='reportes')
